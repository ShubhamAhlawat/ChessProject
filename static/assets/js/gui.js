...
function PreSearch() {
		...
		if(GameController.GameOver != BOOL.TRUE) {				
			...
			$('#ThinkingImageDiv').append('<image src="static/img/chesspieces/think3.png" id="ThinkingPng"/>')
...
function AddGUIPiece(sq,pce) {	
	...
	pieceFileName = "static/img/chesspieces/" + SideChar[PieceCol[pce]] + PceChar[pce].toUpperCase() + ".png";
